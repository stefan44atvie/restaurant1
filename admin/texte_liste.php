<?php 
    ...
    $sql_textliste = "select * from psvb_hp_texte order by create_date DESC";
    ...
    if(mysqli_num_rows($resTL)  > 0) {
        while($rowTL = mysqli_fetch_array($resTL, MYSQLI_ASSOC)){
            ...
            $sql_textart = "select * from psvb_text_art where art_id = $fk_textart";
            ...
            <tr>
                ...
                <td>
                    <div class='btn-group' role='group' aria-label='Basic mixed styles example'>
                        <a type='button' class='btn btn-sm btn-warning button_shadow' href='update_kunde.php?id=$tid'>Update</a>
                        <a type='button' class='btn btn-sm btn-danger button_shadow text-white' href='delete.php?id=".$tid.'&deletetext'."'>Löschen</a>
                    </div>
                </td>
            </tr>
            ";
    ...
    $sql_dashboardtext = "select * from psvb_hp_texte where fk_textart = 17";
