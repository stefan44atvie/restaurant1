            ...
            <tr>
                ...
                <td>
                    <div class='btn-group' role='group' aria-label='Basic mixed styles example'>
                        <a type='button' class='btn btn-sm btn-primary button_shadow text-white' href='details_kunde.php?id=$uid'>Details</a>
                    </div>
                </td>
            </tr>
            ";
    ...
    <section id="events_list">
        <div id="infobox_events">
            <div class="main_box opacity_dark50">
                <h1 class="beisl_standardtitel"> Veranstaltungen im PSV-Beisl</h1>
                ...
                <div class="addTextButton">
                    <a href="create_event.php" class="btn btn-primary w-100">Veranstaltung hinzufügen</a>
                </div>
            </div>
            <div class="right"></div>
        </div>
