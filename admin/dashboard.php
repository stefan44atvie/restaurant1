...
if($_SESSION["superadmin"]){
    ...
    $sql_uploadtimeWK = "select * from psvb_wochenkarte order by wochen_date DESC limit 1";
    ...
    $sql_uploadtimeSK = "select * from psvb_speisekarte order by speise_date DESC limit 1";
    ...
    $sql_events = "select * from psvb_events order by create_date DESC limit 1";
    ...
    //Texte
    $sql_dashboardtext = "select * from psvb_hp_texte where fk_textart = 14";
    $resDBT = mysqli_query($connect,$sql_dashboardtext);
    $rowDBT = mysqli_fetch_assoc($resDBT);
    $dashboard_text = $rowDBT['hp_meldung'];

    $sql_adminabtext = "select * from psvb_hp_texte where fk_textart = 15";
        ...
        <div class="container-fluid">
            ...
            <ul class="navbar-nav mb-2 mb-lg-0">
                ...
                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                    <li>
                        <a class="dropdown-item" href="../index.php">Zur Webseite</a>
                    </li>
